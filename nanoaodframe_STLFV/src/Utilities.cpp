...
namespace
{
  ...
  //----------------------------------------------------------------------
  [[maybe_unused]] float getFloat(const std::string& token)
  {
    char* endptr;
  ...
  //----------------------------------------------------------------------
  [[maybe_unused]] unsigned getUnsigned(const std::string& token)
  {
    char* endptr;
  ...
  //----------------------------------------------------------------------
  [[maybe_unused]] std::string getSection(const std::string& token)
  {
  ...
  //----------------------------------------------------------------------
  [[maybe_unused]] std::vector<std::string> getTokens(const std::string& fLine)
  {
  ...
  //----------------------------------------------------------------------
  [[maybe_unused]] std::string getDefinitions(const std::string& token)
  {
    size_t iFirst = token.find ('{');
    size_t iLast = token.find ('}');
    if (iFirst != std::string::npos && iLast != std::string::npos && iFirst < iLast)
  ...
  //------------------------------------------------------------------------
  [[maybe_unused]] float quadraticInterpolation(float fZ, const float fX[3], const float fY[3])
  {
